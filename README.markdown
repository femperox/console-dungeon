...
- Карта - Андрей
- Боевая сисема - Артём
- Придумать что-нибуть с мобами (может быть разбито на несколько человек)
- Придумать предметы и им функцианальность (может быть разбито на несколько человек)
- можно добавть торговцев
- может быть чтонибеть придумаю
